      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          ...
          <scroll v-if="currentIndex === 1" :data="searchHistory" class="list-scroll" ref="searchList">
            <div class="list-inner">
              <search-list :searches="searchHistory" @delete="deleteSearchHistory" @select="addQuery" :refreshDelay="refreshDelay"></search-list>
            </div>
          </scroll>
        </div>
      </div>
      <div class="search-result" v-show="query" @select="selectSuggest">
